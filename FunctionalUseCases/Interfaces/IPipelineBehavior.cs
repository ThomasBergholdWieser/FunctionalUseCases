...
/// <summary>
/// Pipeline behavior interface that allows wrapping use case execution with additional logic.
...
{
    /// <summary>
    /// Handles the pipeline behavior logic, wrapping the next step in the pipeline.
    /// </summary>
